...
#define CGI_PATH "cgi/cgi" // Path ke program_cgi
...
void get_mime_type(char *file, char *mime) {
    // Buat variabel yang memisahkan extension dari file
    ...
    if (!file) {
        ...
        *response_size = strlen(not_found);
        ...
        if (extension && strcmp(extension, ".php") == 0) {
            ...
            // Buat perintah untuk menjalankan CGI
            //jangan lupa, didepan -- dikasih spasi
            ...
            *response_size = fsize + strlen(response_line);
            ...
            // Alokasikan var msg_body untuk menampung
            // response header dan isi file resource
